...
class VerticalMarquee extends Component<IBearCarouselProps, IState> {
    static defaultProps = {
        data: undefined,
        moveTime: 500,
    ...
    containerRef: React.RefObject<HTMLUListElement> = createRef();
    slideItemRefs: React.RefObject<Array<HTMLDivElement>> = createRef();
    pageRefs: React.RefObject<Array<HTMLDivElement>> = createRef();
                    ...
                    >
                        {this.info.formatElement.map((row, i) => (
                            <li
                                ...
                                onClick={row.onClick}
                            >
                                <div className={styles.slideItemText} dangerouslySetInnerHTML={{__html: row.element}}/>
                            </li>
                        ))}
                    </ul>
                </div>

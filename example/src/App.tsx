        ...
        <div className="App">
            ...
            <div className="card" style={{background: 'blue'}}>
                <BearVerticalMarquee
                    autoPlayTime={2000}
                    data={[
                        {key: 1, text: `<div>Most modern mobile touch slider with hardware accelerated transitions for ReactJS</div><div>aadsdasda</div>`, onClick: () => window.open('https://carousel.bearests.com/')},
